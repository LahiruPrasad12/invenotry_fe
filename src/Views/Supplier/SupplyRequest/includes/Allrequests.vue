<template>
  <div>
    <div class="anim" style="--delay:0.2s;">
      <b-table ref="requestTable" :data="request" :loading="is_table_loading" hover responsive>
        ...
        <b-table-column field="action" label="Action">
          <template v-slot="props">
            <b-tooltip label="View More" position="is-right" target="">
...
export default {
  ...
  methods: {
    ...
    generatePDF() {
      ...
      doc.setFontSize(15);
      doc.text(79, 40, "Supply Requests Report");
      doc.setTextColor(255, 255, 255);
      doc.setFontSize(10);
